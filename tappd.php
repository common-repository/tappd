            ...
            foreach ($feed->response->checkins->items as $i) {
                ...
                $output .= '<div class="venuecheckin">';
                    ...
                    $output .= '<div class="venueusername">';
                        $output .= '<a href="https://untappd.com/user/' . $i->user->user_name . '" >' . $i->user->user_name . '</a> is drinking <a href="https://untappd.com/beer/' . $i->beer->bid . '">' . $i->beer->beer_name . '</a> <span>by <a href="' . $i->brewery->contact->url . '">' . $i->brewery->brewery_name . '</a></span>';
                    $output .= '</div>';
                $output .= '</div>';      
                }
                else{
